...
## Real-time test: the March 2026 oil shock

While this project was being built, the relationship was being demonstrated live. In mid-2025 a Middle East conflict involving Iran sent oil prices sharply higher, and the pass-through to US inflation looks like it was lifted straight out of the lead/lag analysis above.

| Indicator | Feb 2026 | **Mar 2026** | What it shows |
|---|---|---|---|
| Headline CPI YoY | 2.4% | **3.3%** | +0.9pp in one month — biggest jump since 2022 |
| CPI MoM (SA) | — | **+0.9%** | ~11% annualized |
| Core CPI YoY | — | 2.6% | Far tamer than headline |
| Gasoline MoM | — | **+21.2%** | Drove ~75% of the headline jump |
| PPI Final Demand YoY | — | **4.0%** | Producer prices running *ahead* of CPI |
| PPI Energy MoM | — | +8.5% | Commodity shock, upstream first |

This is the project's framework playing out in real time:

1. **Commodities moved first.** PPI energy was already running hot in the months leading up to March, and the oil/gasoline complex took the brunt of the war shock.
2. **CPI followed within the same monthly print.** Gasoline alone explained roughly three-quarters of the March headline jump — the most direct possible commodity-to-consumer channel.
3. **Core stayed muted** (+0.2% MoM, 2.6% YoY) because most non-commodity components don't respond instantly to oil — exactly the slope-of-0.34 caveat from the headline result above.
4. **Producer prices are still leading consumer prices.** PPI final demand at 4.0% YoY vs CPI at 3.3% YoY suggests there is more pipeline pressure to come if the energy shock persists.

The Fed responded by holding the policy rate at 3.5–3.75% for a second consecutive meeting in March 2026, with seven of nineteen FOMC participants now penciling in zero cuts for the rest of 2026 (up from six in December). The Summary of Economic Projections shows headline and core PCE both at 2.7% for end-2026, with the implicit assumption that the war and tariff shocks fade through 2027–28.

**Forward-looking read.** If the historical lead/lag pattern continues to hold, the next two-to-three monthly CPI prints should remain elevated regardless of what oil does from here, because the commodity shock has already been delivered — it just hasn't fully transmitted through the rest of the basket yet. Whether 2027 inflation re-converges toward 2% depends on whether (a) oil retraces, (b) tariff incidence stabilizes, and (c) services disinflation resumes. The base case from this project's framework: 2026 full-year CPI in the **3.0–3.8%** range, with material upside if energy stays elevated, and a slow glide back toward **2.5–3.0%** in 2027 rather than a clean return to the pre-pandemic 1.5–2.0% regime.

*Sources: BLS [CPI March 2026 release](https://www.bls.gov/news.release/cpi.nr0.htm), BLS [PPI March 2026 release](https://www.bls.gov/news.release/ppi.nr0.htm), [March 2026 FOMC statement](https://www.federalreserve.gov/newsevents/pressreleases/monetary20260318a.htm), [March 2026 SEP](https://www.federalreserve.gov/monetarypolicy/fomcprojtabl20260318.htm).*
